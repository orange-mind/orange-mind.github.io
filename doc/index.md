...
<img src="https://orange-mind.github.io/doc/8.png" style="zoom:40%;" />
...
<img src="https://orange-mind.github.io/doc/8-1.png" style="width:400px" />

除此之外，二维码指令为方便操作，还支持了快捷复制（`Ctrl+C`）、快捷保存(`Ctrl+S`)、放大缩小(`Ctrl+=`、`Ctrl+-`)功能（Mac下对应按键前缀为`⌘`），为了进一步提升二维码配置的效率，上述配置弹框还支持取色器，取色器中支持拾取透明颜色，如下所示：

<img src="https://orange-mind.github.io/doc/8-2.png" style="width:400px" />
