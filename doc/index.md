...
<img src="16.gif" style="zoom:67%;" />

该指令配置如下所示：

<img src="16.png" style="zoom:40%;" />
...
<img src="17.gif" style="zoom: 50%;" />

该指令配置如下所示：

<img src="17.png" style="zoom:40%;" />

#### 获取页面加载性能

对于前端开发而言，关注并查看网页的加载性能，几乎是下意识行为，OrangeMind也提供了对应的指令，如下所示：

<img src="19.gif" style="zoom:67%;" />

该指令配置如下所示：

<img src="19.png" style="zoom:40%;" />

#### PDF操作

除了页面截图外，OrangeMind还支持将多张图片合成为PDF，PDF操作涉及到三个快捷指令，操作流程如下所示：

<img src="20.gif" style="zoom:67%;" />

保存的pdf如下所示：

<img src="20.png" style="zoom: 40%;" />

以上操作涉及3个指令，配置如下所示：

<img src="20-1.png" style="zoom:40%;" />
...
<img src="23.gif" style="zoom:67%;" />

该指令配置如下所示：

<img src="23.png" style="zoom:40%;" />

以上是`Markdown`格式的文档，OrangeMind还支持通过`HTML` 来配置文档内容，如下所示：

<img src="24.gif" style="zoom:67%;" />

该指令配置如下所示：

<img src="24.png" style="zoom:40%;" />

#### 添加右键菜单

在OrangeMind的其他配置中，可以动态添加浏览器右键菜单，如下所示：

<img src="25.png" style="zoom: 40%;" />

除此之外，快捷指令也支持快速添加右键菜单，如下所示：

<img src="25.gif" style="zoom: 67%;" />

该指令配置如下所示：

<img src="25-1.png" style="zoom: 40%;" />
...
<img src="editor.gif" style="zoom: 67%;" />
...
<img src="run.gif" style="zoom:60%;" />

#### 编译AST

为了更好的关注代码的语法结构，Web编辑器提供了编译AST功能，如下所示：

<img src="ast.gif" style="zoom: 67%;" />

#### 加密混淆

代码混淆可以在一定程度上隐藏页面代码逻辑，提升业务安全性，具体效果如下所示：

<img src="hunxiao.gif" style="zoom:67%;" />

#### 代码压缩编译

一般前端项目都会编译上线，那么对于单个文件，有没有办法快速压缩呢，如下所示：

<img src="compress.gif" style="zoom: 67%;" />

#### 获取hash

前后端联调时，有时需要hash一段文本，然后上传到后台进行匹配，那么如何获取hash呢，如下所示：

<img src="hash.gif" style="zoom:67%;" />

#### 快速大小写

快速大小写如下所示：

<img src="upCase.gif" style="zoom:67%;" />
...
<img src="code.png" style="zoom: 33%;" />

<img src="code-1.png" style="zoom: 33%;" />
...
<img src="code-html.png" style="zoom: 33%;" />

效果如下所示：

<img src="code-html-1.png" style="zoom: 33%;" />

注入js过程及效果如下所示：

<img src="code-js.gif" style="zoom: 67%;" />

为了更加方便的编写页面脚本，OrangeMind内置了`runtimeId`、`actionId`和`orangeMind`对象，点击js面板右上角的第二个按钮（`问号？`按钮），可以查看帮助文档：

<img src="code-js-1.png" style="zoom: 33%;" />
...
<img src="code-css.png" style="zoom: 33%;" />

效果如下所示：

<img src="code-css-1.png" style="zoom: 33%;" />

除了基础的html、js、css代码外，为了快速注入功能模块，OrangeMind还特别支持了vue代码注入，如下所示：

<img src="code-vue.gif" style="zoom: 67%;" />
...
<img src="fragment.png" style="zoom:33%;" />

点击编辑按钮，打开代码片段编辑弹框如下所示：

<img src="fragment-1.png" style="zoom:33%;" />
...
<img src="fragment.gif" style="zoom: 67%;" />

为了方便随时添加代码片段，Web编辑器中支持将选中文本快速添加为代码片段，如下所示：

<img src="fragment-1.gif" style="zoom:67%;" />
